...
// The connection string is read from MONGODB_URI environment variable, defaulting to a local instance.
const MONGODB_URI = process.env.MONGODB_URI || 'mongodb://localhost:27017/tabletop-collector';
